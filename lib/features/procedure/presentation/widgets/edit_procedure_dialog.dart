...
class EditProcedureDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditProcedureDialog> createState() =>
      _EditProcedureDialogState();
}

class _EditProcedureDialogState extends ConsumerState<EditProcedureDialog> {
  final _formKey = GlobalKey<FormState>();
  late final TextEditingController _nameController;
  late final TextEditingController _descriptionController;
  late final TextEditingController _priceController;
  late final TextEditingController _durationController;
  late List<ProcedureMaterial> _materials;
  ...
  void initState() {
    ...
    _priceController =
        TextEditingController(text: widget.procedure.price.toString());
    _durationController = TextEditingController(
        text: widget.procedure.durationMinutes.toString());
    _materials = List.from(widget.procedure.materials);
  }
  ...
  Future<void> _updateProcedure() async {
    ...
    try {
      ...
      final updatedProcedure = ProcedureModel(
        ...
        clinicId: widget.procedure.clinicId,
        isActive: widget.procedure.isActive,
        createdAt: widget.procedure.createdAt,
      ...
      await firestore
          ...
          .doc(updatedProcedure.id)
          .update(updatedProcedure.toJson());
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _isLoading ? null : _updateProcedure,
                    child: _isLoading
                        ? const SizedBox(
                            width: 20,
                            height: 20,
